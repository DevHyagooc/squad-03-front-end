...
import FormHeader from "../alterarSenha/formHeader";
      ...
      >
       {/* Campo de nova senha */}
        <div className="text-gray-700 focus-within:text-cyan-500">
          ...
          {errors.novaSenha && (
            <div id="novaSenha-error" className="text-xs text-red-600 pt-1">
              {errors.novaSenha.message as string} {/* Certifique-se de que isso é uma string */}
            </div>
          )}
        </div>
