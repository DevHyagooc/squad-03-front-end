                  ...
                  {getEntregaveisByStatus(column.status).map((entregavel) => (
                    ...
                    >
                      <CardContent className="p-3">
                        <p className="text-sm font-medium mb-1 line-clamp-1">{entregavel.nome || "Sem título"}</p>
          ...
          {selectedEntregavel && (
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-700">{selectedEntregavel.nome || "Sem título"}</p>
              </div>
              <div>
